        ...
        <div class="header">
            ...
            <div class="top-nav">
                <ul class="nav1">
                    ...
                    <li class="hvr-sweep-to-bottom active"><a href="about.jsp">产品系列<i>产品都称心，体验更如意。</i></a></li>
                        ...
                        <li><a class="active-icon c1" href="#" id="cart">购物车</a>
                            ...
                            <ul class="sub-icon1 list">
                                ...
                                <div class="login_buttons">
                                    <div class="login_button"><a href="#" onclick="submitShopCart()">&nbsp;&nbsp;结&nbsp;&nbsp;算&nbsp;&nbsp;</a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="clearfix"></div>
...
<div class="about-top" style="background-color: white">
    ...
    <div class="container" style="text-align: center">
        <div class="col-md-5 banner-bottom-right wow fadeInRight animated animated" data-wow-delay="0.5s"
            ...
            <div>
                <p style="font-size: 50px ;font-weight: bold;letter-spacing: 7px;font-family: 黑体;padding-bottom: 35px">
                    看看哪款<span id="Pname">产品</span>适合你</p>
...
<div class="products-bottom" style="background-color: white">
    ...
    <div class="container" id="im">
        <h3 class="wow fadeInRight animated" data-wow-delay="0.4s"
            style="visibility: visible; -webkit-animation-delay: 0.4s;">了解更多</h3>
        ...
        $.post("/selectProduct",
            ...
            function (data, status) {
                ...
                $(AP).each(function () {
                    ...
                    var univalence = $("<p></p>").text("RMB " + this.price + " 起");
                    var but = $("<button></button>").text("购买").bind("click", {
                        GoodsID: this.id,
                        UserID: Uid
                    }, addShopCart);
                    ;
                    var Wrap = $("<br>");
                    var catenate = $("<a></a>").text("进一步了解 >");
